...
- **Riches Beyond Renown (ACTIVE)**: Can alter enemy Heroes' Courage tests within 12".
...
This format structures the Haradrim army with clarity, giving detailed insights into each hero's abilities and equipment. The layout provides easy navigation and understanding of each unit's capabilities and roles within the army. For completeness, you can continue with a similar structure for the remaining units, detailing their wargear, options, and special rules.
...
- Haradrim Commander: Armour, War Spear
- Mumak: Howdah (Capacity: 12 models + commander)
...
- **Trample**: Inflicts three Strength 9 hits when charging.
- **Awesome Presence (PASSIVE)**: Friendly Haradrim and Mahud models within 3" may re-roll a single D6 when making a Duel roll.
...
- **Whip of the Masters (ACTIVE)**: When a friendly Hero within 6" attempts a Heroic Move, March, or Shoot, roll a D6. On a 4+, the action does not cost Might.
...
This format provides a detailed overview of each unit in "The Serpent Horde," highlighting their abilities, equipment, and roles within the army. This structured presentation aids in quick reference and understanding of the army's capabilities in the context of gameplay.
